...
def dot_product_attention(q,
    ...
    Args:
    q: a Tensor with shape [batch, heads, length_q, depth_k]    query
    k: a Tensor with shape [batch, heads, length_kv, depth_k]   key
    v: a Tensor with shape [batch, heads, length_kv, depth_v]   value
